...
<body>
    ...
    <div class="form">
        <form action="rolled" method="post">
        
            <div class="img">
                <img src="Rolled-icecream.jpg" alt="Italian Trulli" width="150px" height="150px">
            </div>
            <br>
             <input name="username" type="hidden" value="<%=session.getAttribute("uname") %>">
            <label>Name    : Rolled Ice</label>
            <br>
            <br>
